...
module SpecHelper
  ...
  NUMEROLOGY = {
    ...
    "3" => { birthdate: "12171999", message: "Number Three is a sociable, friendly, and outgoing vibration. Kind, positive, and optimistic, Threes enjoy life and have a good sense of humor. Ruled by Jupiter." },
